...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['cs_id'])) {
        ...
        // Use the existing data as default values for fields that aren't provided
        $topsheet = isset($_POST['topsheet']) && $_POST['topsheet'] !== '' ? 
            filter_var($_POST['topsheet'], FILTER_SANITIZE_NUMBER_INT) : $currentData['topsheet'];
        ...
        $driver = isset($_POST['driver_name']) && $_POST['driver_name'] !== '' ? 
            filter_var($_POST['driver_name'], FILTER_SANITIZE_STRING) : $currentData['driver'];
            
        $helper1 = isset($_POST['helper1_name']) && $_POST['helper1_name'] !== '' ? 
            filter_var($_POST['helper1_name'], FILTER_SANITIZE_STRING) : $currentData['helper1'];
            
        $helper2 = isset($_POST['helper2_name']) && $_POST['helper2_name'] !== '' ? 
            filter_var($_POST['helper2_name'], FILTER_SANITIZE_STRING) : $currentData['helper2'];
        ...
        $stmt->bind_param("iissssssssssssssi", 
            $topsheet, $waybill, $date, $status, $delivery_type, 
